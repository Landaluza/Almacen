        ...
        Try
            If Grid.ColumnCount > 0 Then
                ...
                If Type = MicrosoftOfficeExporter.ONE Then
                    ...
                    CType(oSheet.Columns("B:B"), Microsoft.Office.Interop.Excel.Range).ColumnWidth = 20
                    CType(oSheet.Columns("C:C"), Microsoft.Office.Interop.Excel.Range).ColumnWidth = 20
